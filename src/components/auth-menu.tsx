        ...
        <>
          ...
          <div
            ...
            className={[
              ...
              "md:inset-x-auto md:right-4 md:top-20 md:bottom-auto md:w-[320px] md:max-h-[80dvh] md:rounded-2xl md:border md:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] md:animate-fade-in",
            ].join(" ")}
          >
