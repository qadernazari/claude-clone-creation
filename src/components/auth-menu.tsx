  ...
  if (!user) {
    return (
      <div className="flex w-[78px] justify-end">
        <Link
          to="/auth"
          className="inline-flex min-h-10 items-center justify-center rounded-full border border-cream/35 bg-cream/8 px-4 py-2 text-sm font-medium text-cream hover:bg-cream/15 hover:border-cream/50 transition-colors"
        >
          {fa ? "ورود" : "Sign in"}
        </Link>
      </div>
