    ...
    <section className="relative isolate overflow-hidden">
      ...
      <div className="relative h-[82svh] min-h-[520px] w-full overflow-hidden bg-bg-1 md:h-[100dvh] md:min-h-[640px]" style={{ background: fallbackBg }} data-mobile-hero>
        {hasAnyImage ? (
          <>
            <div
              className="hero-mobile-poster absolute inset-x-0 bottom-0 top-16 bg-cover bg-center md:hidden"
              style={{
            ...
            />
            <div
              className={`hero-mobile-skeleton absolute inset-x-0 bottom-0 top-16 md:hidden ${
            ...
            {mobileImage ? (
              <img
                src={mobileImage}
                alt=""
                className={`hero-mobile-img cine-img absolute inset-x-0 bottom-0 top-16 w-full object-cover object-center transition-opacity duration-500 md:hidden ${
