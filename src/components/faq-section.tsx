...
const FA: QA[] = [
  {
    q: "عضویت IRAN چیست؟",
    a: "اشتراکِ ماهانه‌ای که به کلِ کاتالوگ ما — آثار اوریجینال، مستندها و مجموعه‌های منتخب — دسترسی می‌دهد. آثار تازه به‌طور منظم اضافه می‌شود. با ۷ روز آزمایش رایگان شروع کنید.",
  },
  {
    q: "هزینه چقدر است؟ آزمایش رایگان وجود دارد؟",
    a: "قیمت هنگام پرداخت به ارز محلی شما نشان داده می‌شود. اعضای جدید ۷ روز آزمایش رایگان دارند — در این مدت مبلغی برداشت نمی‌شود و هر زمان می‌توانید لغو کنید.",
  },
  {
  ...
  },
  {
    ...
    a: "بله. از حساب ← مدیریت اشتراک لغو کنید. دسترسیِ شما تا پایانِ دوره‌ی پرداخت‌شده‌ی فعلی ادامه می‌یابد.",
  },
  {
