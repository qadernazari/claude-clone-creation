...
const FA: QA[] = [
  {
    q: "عضویت IRAN چیست؟",
    a: "عضویتِ ماهانه‌ای که به کلِ کاتالوگ ما — آثار اوریجینال، مستندها و مجموعه‌های منتخب — دسترسی می‌دهد. آثار تازه به‌طور منظم اضافه می‌شود. با ۷ روز آزمایش رایگان شروع کنید.",
  },
  {
