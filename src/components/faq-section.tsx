...
const FA: QA[] = [
  {
    q: "عضویت IRAN چیست؟",
    a: "اشتراکِ ماهانه‌ای که به همه‌ی آثار ما — آثارِ اختصاصی، مستندها و مجموعه‌های منتخب — دسترسی می‌دهد. آثار تازه به‌طور منظم اضافه می‌شود. با ۷ روز آزمایش رایگان شروع کنید.",
  },
  {
