...
const FAQ_EN: { q: string; a: string }[] = [
  {
    ...
    a: "New accounts get 90 days of full access to the entire catalog — no payment required upfront. After 90 days you can choose a membership plan. If you don't subscribe, your access simply ends.",
  },
  {
...
const FAQ_FA: { q: string; a: string }[] = [
  {
    ...
    a: "حساب‌های جدید ۹۰ روز دسترسی کامل به همه‌ی کاتالوگ دارند — بدون نیاز به پرداخت اولیه. پس از ۹۰ روز می‌توانید پلن عضویت انتخاب کنید. اگر مشترک نشوید، دسترسی شما به‌سادگی پایان می‌یابد.",
  },
  {
