...
const SECTIONS_EN: { title: string; body: React.ReactNode }[] = [
  ...
  },
  {
    ...
    body: (
      <p>
        New accounts receive a 90-day free trial with full access to the catalog. Only one free
...
const SECTIONS_FA: { body: React.ReactNode }[] = [
  ...
  },
  {
    body: (
      <p>
        حساب‌های جدید ۹۰ روز آزمایش رایگان با دسترسی کامل به کاتالوگ دریافت می‌کنند. هر شخص فقط یک
